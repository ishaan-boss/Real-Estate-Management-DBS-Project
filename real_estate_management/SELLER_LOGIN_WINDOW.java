 ...
 * @author Mudit
 */
public class SELLER_LOGIN_WINDOW extends javax.swing.JFrame {

    /**
     * Creates new form LOGIN_WINDOW
     */
    public SELLER_LOGIN_WINDOW() {
        initComponents();
    ...
    private void jButton_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoginActionPerformed
        ...
        ResultSet rs;
        String selectQuery="SELECT * from Seller WHERE Email=? AND Password =?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SELLER_LOGIN_WINDOW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SELLER_LOGIN_WINDOW().setVisible(true);
            }
        });
    }
