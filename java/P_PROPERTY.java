...
//        System.out.println("INSIDE FEATURES")+;
        ...
        System.out.println("Inside prop features"+LatitudeFloat);
...
//        int sid = getSID();
       // System.out.println(sid);
        ...
        String addQuery_Rating="insert into rating values (?,0,0);";
        try {
...
//            }
             ...
             ps.setFloat(3,property.getLongitudeFloat());
              i = ps.executeUpdate();
             ps = THE_CONNECTION.getTheConnection().prepareStatement(addQuery_Rating); 
             ps.setInt(1, property.getPID());
             i=ps.executeUpdate();
            return (i >0);
